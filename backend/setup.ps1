...
$PythonPath = "C:\Users\mnina\AppData\Local\Programs\Python\Python311\python.exe"
...
Write-Host "Virtual environment setup complete. To activate it, run '$ScriptDir\venv\Scripts\Activate'"